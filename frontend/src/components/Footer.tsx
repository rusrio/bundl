    ...
    <footer className={styles.footer}>
      <div className={styles.container}>
        <div className={styles.brand}>
          <svg className={styles.brandSvg} width="24" height="24" viewBox="0 0 48 48" fill="none">
          ...
          <span className={styles.brandName}>Bundl Index Protocol</span>
        </div>
        <div className={styles.links}>
          <a href="#" className={styles.link}>Docs</a>
          <a href="#" className={styles.link}>Governance</a>
          <a href="#" className={styles.link}>Fees</a>
          <a href="#" className={styles.link}>Security</a>
        </div>
        <p className={styles.copyright}>© 2026 Bundl. Build portfolios with confidence.</p>
      </div>
    </footer>
  );
}
